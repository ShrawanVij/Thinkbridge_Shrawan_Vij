...
public class AuthorizationTests
{
    ...
    // Every test gets its own on-disk SQLite files (a shared default path
    // would let one test's inserted rows — and their auto-increment ids —
    // leak into another's assertions, since nothing here deletes them
    // between tests).
