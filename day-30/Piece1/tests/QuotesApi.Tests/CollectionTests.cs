...
public class CollectionTests
{
    ...
    {
        Assert.Throws<ArgumentException>(() => new Collection(1, "AB"));
    }
    ...
    public void RejectsNameLongerThan80Characters()
    {
        ...
        Assert.Throws<ArgumentException>(() => new Collection(1, name));
    }
    ...
    public void RejectsDuplicateQuote()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => collection.AddItem(10, _clock));
    }
    ...
    public void RejectsMoreThan50Items()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => collection.AddItem(51, _clock));
    }
